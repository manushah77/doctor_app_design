...
import 'package:doctor/Doctor_screens/History_call/video_call_history_note.dart';
import 'package:doctor/Doctor_screens/History_call/voice_call_history_note.dart';
...
class DrHistoryPage extends StatefulWidget {

  @override
  State<DrHistoryPage> createState() => _DrHistoryPageState();
}

class _DrHistoryPageState extends State<DrHistoryPage> {
  @override
                                    ...
                                    InkWell(
                                      onTap: (){
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => DrVoiceCallHistoryNote(),
                                          ),
                                        );
                                      },
                                      child: Container(
                                    ...
                                    InkWell(
                                      onTap: (){
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => DrVideoCallHistoryNote(),
                                          ),
                                        );
                                      },
                                      child: Container(
